...
sidebar presents component families alphabetically with Foundations first, while
each story retains its R1 tranche metadata and deep-link ID. The explicit
