...
export function assertReactR15GeneratedContracts({
  ...
  if (manifest?.private !== true
    ...
    || descriptor.bindings?.length !== 79
    || descriptor.exports?.length !== 79
    ...
    || release.componentExports?.length !== 79
    || release.bindings?.length !== 79
    || release.catalog?.status !== 'bound'
    || release.catalog.components?.length !== 79
    ...
    || currentContract.current?.familyCount !== 79
    || currentContract.current?.fixed53Count !== 53
    || currentContract.current?.supplementalCount !== 26
    || currentContract.components?.length !== 79
