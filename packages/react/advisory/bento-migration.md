...
| --- | --- | --- |
| B10 | Consumable theme tokens, selectable preset assets, and metadata | Expose a Mux artifact/API or define a Bento build adapter over the existing canonical theme data/compiler. The palettes already exist. |
